            ...
            <tbody>
                ...
                try {
                    ...
                    ResultSet rs = st.executeQuery(
                        "SELECT t.*, COALESCE(a.available_seats, t.max_seats) as available_seats " +
                        "FROM trains t LEFT JOIN available_seats a ON t.train_number = a.train_number"
                    );
                    while (rs.next()) {
                %>
                <tr>
                    ...
                    <td class="action-buttons">
                        <a href="edit-train.jsp?trainId=<%= rs.getString("train_number") %>" class="button">Edit</a>
                        <a href="delete-train.jsp?trainId=<%= rs.getString("train_number") %>" class="button delete">Delete</a>
                    </td>
                </tr>
                <%
                    }
